#' Example codebook
#'
#' A data frame providing plot labels for the [data] dataset. Used to
...
#'
#' @format A data frame with one row per variable in [data] and the following columns:
#' \describe{
...
#' }
#' @seealso [data] for the matching survey dataset; [impute_labs()] for the function that reads from a codebook.
"codebook"