  ...
  theme +
    theme(
      ...
      axis.ticks.y = element_line(color = .uwb_vals$axiscol,
         linetype = "solid", linewidth = .uwb_vals$axissize),
      ...
      plot.caption = ggtext::element_textbox_simple(
        size = 0.85 * .uwb_vals$tsize, family = font, hjust = 0, lineheight = .uwb_vals$lineheight),
      plot.caption.position = "plot",
      strip.text = ggtext::element_markdown(size = .uwb_vals$tsize, family = font, margin = margin(b = 1.5)),
      axis.title = ggtext::element_markdown(color = .uwb_vals$axiscol, size = .uwb_vals$tsize, family = font),
      axis.text = ggtext::element_markdown(
        size = .uwb_vals$tsize, family = .uwb_vals$font, lineheight = .uwb_vals$lineheight),
      axis.text.y = ggtext::element_markdown(
        color = .uwb_vals$axiscol, margin = margin(r = 5, l = 5, t = 5, b = 5))
    )
}
  ...
  theme +
    theme(
      axis.line.x = element_line(
        color = .uwb_vals$axiscol, linetype = "solid", linewidth = .uwb_vals$axissize),
      axis.line.y = element_blank(),
      axis.text.y = ggtext::element_markdown(color = "black", margin = margin(r = 5, l = 5, t = 5, b = 5)),
      axis.text.x = ggtext::element_markdown(color = .uwb_vals$axiscol, margin = margin(r = 5, l = 5, t = 5, b = 5)),
